      ...
      <div v-for="catGroup in itineraryData.categoryGroups" :key="catGroup.id" class="itin-group-elem w-full flex flex-col">
        ...
        >
          <NuxtLink 
            ...
            class="group block relative scroll-snap-align-start shrink-0 rounded-3xl overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.05)] hover:shadow-[0_6px_16px_rgba(0,0,0,0.12)] transition-all duration-500 bg-[#1A1A1A] w-[75vw] sm:w-[48vw] ring-1 ring-black/5 lg:w-[320px] xl:w-[360px] aspect-[5/4]"
            @dragstart.prevent
          >
