  ...
  <section ref="sectionRef" class="relative w-full pt-10 md:pt-14 pb-4 md:pb-8 bg-[#f9f8f6] flex flex-col overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-[90rem] mx-auto px-6 md:px-16 lg:px-24 flex justify-center mb-6 lg:mb-8">
      <div class="max-w-4xl flex flex-col items-center text-center">
        ...
        >
          ...
          <span class="font-normal leading-normal text-[#673b1c] italic capitalize">{{ testimonialsData.header.titleItalic }}</span>
        </h4>
    ...
    <div class="testi-slider-wrapper w-full max-w-[60rem] mx-auto px-4 md:px-12 flex flex-col items-center overflow-hidden">
      ...
      <div class="flex items-center justify-center gap-6 mt-4 md:mt-6 relative w-full px-4 z-10">
        <button class="testi-prev flex w-10 h-10 md:w-12 md:h-12 rounded-full border border-[#1A1A1A]/20 bg-[#FFF9E0]/10 items-center justify-center text-[#1A1A1A] hover:border-[#673b1c] hover:text-[#673b1c] transition-colors shadow-sm cursor-pointer shrink-0">
        ...
        <button class="testi-next flex w-10 h-10 md:w-12 md:h-12 rounded-full border border-[#1A1A1A]/20 bg-[#FFF9E0]/10 items-center justify-center text-[#1A1A1A] hover:border-[#673b1c] hover:text-[#673b1c] transition-colors shadow-sm cursor-pointer shrink-0">
